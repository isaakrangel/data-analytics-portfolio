...
#pines motores dosificador
 # pines enable puente H de motores de dosificadores
GPIO.setup(in11, GPIO.OUT)
GPIO.setup(in13, GPIO.OUT)
GPIO.setup(in14, GPIO.OUT) 
#pines motores banda
 # pines enable puente H de motores de bandas
...
while True:
        ...
        if apagado_emergencia == False and inicio == False:
            print('esperando pulsador')#finalizar pwm / motores apagados
            Apagar_Valvulas(3)
            Apagar_Motores_Banda()
            Apagar_Motores_Dosificador()
            continue
